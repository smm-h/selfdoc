...
from selfdoc_core import (
    register_post_check_hook,
    register_post_parser,
    register_post_provider,
)
...
# Register the post provider, parser and post-check hook so selfdoc_core's
# build pipeline and selfdoc's check pipeline can handle posts without
# importing selfblog.
register_post_provider(discover_posts)
register_post_parser(parse_post)
