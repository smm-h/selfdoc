...
func (a *assemblyTree) writeSourceProject() {
	...
	a.Write("source/alpha/docs/_build/index.html",
		integratePage("Alpha", "alpha/", "new alpha", "1.0.0"))
	a.Write("source/alpha/docs/_build/guide/index.html",
	...
	a.Write("source/alpha/docs/_build/blog/index.html",
		integratePage("Alpha Posts", "blog/", "standalone listing", "1.0.0"))
	a.Write("source/alpha/docs/_build/blog/hello/index.html",
		integratePage("Hello", "blog/hello/", "hello", "1.0.0"))
	// Per-project deploy artifacts the assembly must not inherit.
	a.Write("source/alpha/docs/_build/_headers", "/*\n  X-Frame-Options: DENY\n")
	a.Write("source/alpha/docs/_build/_redirects", "/* /index.html 200\n")
	a.Write("source/alpha/docs/_build/_worker.js", "export default {}\n")
	a.Write("source/alpha/docs/_build/index.html.gz", "gzipped")
...
func TestAPostsScopePublishWithNoPostsPublishesNothing(t *testing.T) {
	...
	tree := newAssemblyTree(t)
	tree.Remove("source/alpha/docs/_build/blog")
