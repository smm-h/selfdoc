...
//   - Every project is reachable. The generated project listing links every
//     declared project's index page, so no project is published at an address
//     a reader arriving at the site never sees and a crawler following links
//     never reaches. The front page curates what it shows and is not asked.
//     The home project is exempt: the site root is its own front page.
