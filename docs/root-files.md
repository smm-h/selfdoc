...
Add the template paths to `root_files` in your `selfdoc.json`:
...
Every generated root file starts with an auto-generated header comment:
...
Run `selfdoc gen` to regenerate all root files:
