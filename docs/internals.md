...
selfdoc is one Go module, `github.com/smm-h/selfdoc`, with one binary at `cmd/selfdoc` and every engine package under `internal/`. Package names below are those import paths.
